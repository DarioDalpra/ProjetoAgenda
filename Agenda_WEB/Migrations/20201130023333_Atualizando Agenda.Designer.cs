...
namespace Agenda_WEB.Migrations
{
    ...
    [Migration("20201130023333_Atualizando Agenda")]
    partial class AtualizandoAgenda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agenda_WEB.Models.Agenda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agenda_WEB.Models.Agenda", b =>
                {
                    b.HasOne("Agenda_WEB.Models.Paciente", "Cpf")
                        .WithMany()
                        .HasForeignKey("CpfId");

                    b.HasOne("Agenda_WEB.Models.Medico", "Especialidade")
                        .WithMany()
