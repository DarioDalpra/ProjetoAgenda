...
namespace Agenda_WEB.Controllers
{
    ...
    public class PacientesController : BaseController
    {
        ...
        {
            return View(_mapper.Map<IEnumerable<Paciente>>(await _pacientesRepository.ObterTodos()));
        }
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            ...
            var pacienteViewModel = _mapper.Map<Paciente>(await _pacientesRepository.ObterPorId(id));
        ...
        public async Task<IActionResult> Create(Paciente pacienteViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, Paciente pacienteViewModel)
        {
